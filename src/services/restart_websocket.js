...
var getAccessTokenAndConnectWebSocket = function () { return __awaiter(void 0, void 0, void 0, function () {
    var dbConnection, rows, accessToken, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, dbConnection.execute("\n      SELECT access_token\n      FROM access_tokens\n      ORDER BY created_at DESC\n      LIMIT 1\n    ")];
            case 2:
                rows = (_a.sent())[0];
                if (rows.length === 0) {
                ...
                return [4 /*yield*/, (0, websocketService_1.default)(accessToken)];
            case 3:
                _a.sent();
            ...
            case 4:
                _a.sent();
                return [3 /*break*/, 7];
            case 5: return [4 /*yield*/, dbConnection.end()];
            case 6:
                _a.sent();
            ...
            case 8:
                error_1 = _a.sent();
                console.error("Failed to retrieve access token and connect WebSocket:", error_1);
                throw error_1;
